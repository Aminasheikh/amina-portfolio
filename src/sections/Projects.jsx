...
const projects = [
  {
    ...
    desc: 'A full-stack social platform with secure user authentication, dynamic post feeds, and real-time messaging. Built with Next.js, Prisma ORM with Supabase for data handling, and Socket.io for live chat between users.',
    tech: ['Next.js', 'TypeScript', 'Prisma', 'Supabase', 'Socket.io'],
    icon: Users,
    color: '#7c3aed',
    github: 'https://github.com/Aminasheikh/social-network',
    live: null,
    tag: 'Full Stack',
  },
  {
  ...
  },
  {
    ...
    tech: ['Node.js', 'Express.js', 'JavaScript', 'CLI'],
    icon: Terminal,
    color: '#06d6a0',
  ...
  {
    title: 'Handle API',
    desc: 'A project demonstrating REST API integration and consumption. Fetches, displays, and manages data from external APIs using async/await patterns and proper error handling.',
